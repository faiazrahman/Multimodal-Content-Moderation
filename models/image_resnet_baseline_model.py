...
class ImageResnetBaselineModel(nn.Module):
    ...
    def __init__(
        ...
        super(ImageResnetBaselineModel, self).__init__()
        self.image_module = image_module
        self.fc1 = torch.nn.Linear(in_features=image_feature_dim, out_features=hidden_size)
...
class ImageResnetBaselineMMFNDModel(pl.LightningModule):

    def __init__(self, hparams=None):
        super(ImageResnetBaselineMMFNDModel, self).__init__()
        if hparams:
        ...
        self.model = ImageResnetBaselineModel(
