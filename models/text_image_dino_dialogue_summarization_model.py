...
class TextImageDinoDialogueSummarizationModel(nn.Module):
    ...
    def __init__(
            ...
            loss_fn,
            text_module,
            # image_module, # TODO rm
            dialogue_module,
            text_feature_dim,
            # image_feature_dim, # TODO rm
        ...
        super(TextImageDinoDialogueSummarizationModel, self).__init__()
        ...
        # The DINO ViT embedding is used as our image embedding
        image_feature_dim = dino_embedding_dim
    ...
    def forward(self, text, image_pixel_values, dialogue, label):
        ...
        image_features = dino_embedding.last_hidden_state[:,0]
...
class TextImageDinoDialogueSummarizationMMFNDModel(pl.LightningModule):

    def __init__(self, hparams=None):
        super(TextImageDinoDialogueSummarizationMMFNDModel, self).__init__()
        if hparams:
        ...
        self.model = TextImageDinoDialogueSummarizationModel(
