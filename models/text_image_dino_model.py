...
class TextImageDinoModel(nn.Module):
    ...
    def __init__(
        ...
        super(TextImageDinoModel, self).__init__()
    ...
    def forward(self, text, image_pixel_values, label):
...
class TextImageDinoMMFNDModel(pl.LightningModule):

    def __init__(self, hparams=None):
        super(TextImageDinoMMFNDModel, self).__init__()
        if hparams:
